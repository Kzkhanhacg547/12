...
def create_canvas(user_data):
    background_image = Image.open("data/bantho.jpeg")
    ...
    draw.text((700, 1000), "Xin Chia Buon Cung Gia Dinh:", font=font_title, fill=(300, 300, 300))
...
def handle_user_info(message, message_object, thread_id, thread_type, author_id, client):
    try:
        ...
        if os.path.exists(canvas_path):
            ...
            confirmation_message = Message(text="Đã gửi ảnh người mất 🤕.")
