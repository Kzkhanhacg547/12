...
def create_canvas(user_data):
    background_image = Image.open("data/batgiam.jpg")
    ...
    draw.text((70, 800), "Da Bat Thanh Cong ", font=font_title, fill=(0, 0, 0))
...
def handle_user_info(message, message_object, thread_id, thread_type, author_id, client):
    try:
        ...
        if os.path.exists(canvas_path):
            ...
            confirmation_message = Message(text="Đã bắt giam thành công con lợn này,miễn cãi lên phường.")
            client.replyMessage(confirmation_message, message_object, thread_id, thread_type,ttl=1200000)
